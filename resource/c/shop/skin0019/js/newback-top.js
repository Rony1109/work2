define(function(require, exports, module) {
	$.fn.extend({
		addCss: function() {
			...
			'.g-code{position: absolute;right: 62px;z-index: 9999;bottom:0;width: 152px;height: 148px;background: url(//res.csc86.com/v2/m/back-top/img/bg.png) no-repeat;}</style>');
			return this;
		},
		goBack: function(hide) {
			...
			$this.find('.aside_top').on('click', function() {
				$window.scrollTop(0);
			});
			$this.find('.aside_evm').on('mouseenter mouseleave', function(e) {
				$this.find('.evm')[e.type === 'mouseenter' ? 'show' : 'hide']();
			});
			...
			$('.scrollzx').hover(function(){
				$(this).css({'color':'#fe6a1a','text-decoration':'none'});
				$(this).find('img').attr('src','//res.csc86.com/v2/c/shop/skin0019/image/sq-2.png');
			},function(){
				$(this).find('img').attr('src','//res.csc86.com/v2/c/shop/skin0019/image/sq-12.png');
				$(this).css('color','#818181');
			})

			$('.scrolljhc').hover(function(){
				$(this).css({'color':'#fe6a1a','text-decoration':'none'});
				$(this).find('img').attr('src','//res.csc86.com/v2/c/shop/skin0019/image/sq-1.png');
				$(this).find('em').css('background-image','url(//res.csc86.com/v2/c/shop/skin0019/image/sqicon.png)');
			},function(){
				$(this).find('img').attr('src','//res.csc86.com/v2/c/shop/skin0019/image/sq-11.png');
				$(this).css('color','#818181');
				$(this).find('em').css('background-image','url(//res.csc86.com/v2/c/shop/skin0019/image/sqicon1.png)');
			})

			$('.scrollwx').hover(function(){
				$(this).css({'color':'#fe6a1a','text-decoration':'none'});
				$(this).find('img').attr('src','//res.csc86.com/v2/c/shop/skin0019/image/sq-3.png');
			},function(){
				$(this).find('img').attr('src','//res.csc86.com/v2/c/shop/skin0019/image/sq-13.png');
				$(this).css('color','#818181');
			})

			$('.scrolltop').hover(function(){
				$(this).css({'color':'#fe6a1a','text-decoration':'none'});
				$(this).find('img').attr('src','//res.csc86.com/v2/c/shop/skin0019/image/sq-4.png');
			},function(){
				$(this).find('img').attr('src','//res.csc86.com/v2/c/shop/skin0019/image/sq-14.png');
				$(this).css('color','#818181');
			})
