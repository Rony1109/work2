define(function(require, exports, module){
	...
	var Wp={
		...
		index:function(){
			...
			$(".rmpro-hd").find('li').on('click',function(){
				 var that=$(this);
				 var len=$(".rmpro-hd").find('li').length;
				 ...
				 $(".rmpro-hd").next('.jpres-lst').find('.pic').find('a').attr('href',jsonlist.href);
				 $(".rmpro-hd").next('.jpres-lst').find('.pic').find('a').find('img').attr('src',jsonlist.bigPic);
				 $(".rmpro-hd").next('.jpres-lst').find('.price').html(jsonlist.price);
				 $(".rmpro-hd").next('.jpres-lst').find('.buy').attr('href',jsonlist.href);
				 $(".rmpro-hd").next('.jpres-lst').find('.title').find('a').html(jsonlist.title);
				 $(".rmpro-hd").next('.jpres-lst').find('.title').find('a').attr('href',jsonlist.href);
				 $(".rmpro-hd").next('.jpres-lst').find('.jsFavPro').attr('data-id',jsonlist.id);
				 return false;
			})
