define(function(require, exports, module){
	...
	var Wp={
		...
		init:function(){
			...
			/*
			//左侧热门产品
			$('.jsHotProLst').delegate('.pic','mouseenter',function(){
				var _this=$(this);
				_this.parent().addClass('hover').siblings('li').removeClass('hover');
			}).delegate('.pic','mouseleave',function(){
				var _this=$(this);
		...
		product:function(){
			...
			placeholder.placeholder('#srchIpt2','#ccc');
