    ...
    MyDropLoad.prototype.init = function(options){
        ...
        me.opts = $.extend({}, {
            ...
            domUp : {                                                            // 上方DOM
                ...
                domRefresh : '<div class="dropload-refresh"><span>↓</span>下拉刷新</div>',
                domUpdate  : '<div class="dropload-update"><span>↑</span>释放更新</div>',
                domLoad    : '<div class="dropload-load"><span class="loading"></span>加载中...</div>'
            },
            domDown : {                                                          // 下方DOM
                domClass   : 'dropload-down',
                domRefresh : '<div class="dropload-refresh"><span>↑</span>上拉加载更多</div>',
                domUpdate  : '<div class="dropload-update"><span>↓</span>释放加载</div>',
                domLoad    : '<div class="dropload-load"><span class="loading"></span>加载中...</div>'
            },
            distance : 50,                                                       // 拉动距离
            loadUpFn : '',                                                       // 上方function
