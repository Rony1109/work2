	...
	module.exports = {
		init: function ( id ) {
			...
			var ue = UE.getEditor( id, {
				...
				toolbars: [
					["bold","italic","underline","strikethrough","forecolor","backcolor","justifyleft","justifycenter","justifyright","justifyjustify","fullscreen","insertunorderedlist","insertorderedlist","unlink","link","inserttable","deletetable","insertimage","undo","redo","cleardoc","template"]
				],
	...
	var moduleTemplate = {
		preSavetemp: function () {
			var a = $( "#gz-save-box" ),
				...
				e = $( "#temp-count" );
			// 查询我的模板
			$.get("/product/sell/GetMyTmpls", function ( res ) {
		...
		saveTemp: function () {
			...
			if ( r1[0].checked ) {
				// 新增模板
				url = "/product/sell/addTmpl";
				data = {'content': content, 'name': c.val() };
				
			} else if ( r2[0].checked ) {
				// 替换模板
				url = "/product/sell/updateTmpl";
