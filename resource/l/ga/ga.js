/*
window.cscdebug = true;
var gurl = '//gol.csc86.com/ga/cscanalytics.js';
...
(function() {
    ...
    var Rd = [{
        ...
        {
            V: /^pr(\d+)arc$/,
            W: "ec:product %s allprice"
        },
        {
            V: /^pr(\d+)asc/,
            W: "ec:product %s allSpecies"
        },
        {
            V: /^pr(\d+)cpc$/,
            W: "ec:product %s CpnPrc"
        },
        {
            V: /^pr(\d+)cpnid$/,
            W: "ec:product %s Cpnuuid"
        },
        {
            V: /^pr(\d+)cd(\d+)$/,
    ...
    var hd = function() {
            //先屏蔽https
            return "//gol.csc86.com";
            //return ($b || df() ? "https:": "http:") + "//gol.csc86.com"
        },
        bc = function(a) {
            this.name = "len";
            this.message = a + "-8192"
    ...
    var Mi = W("memberId","memberId"),EVP = W("evip","evip"),CY = W("category","category"),TS = W("tradeIds","tradeIds"),SAT = W("shopAddTime","shopAddTime"),PAT = W("productAddTime","productAddTime"),IR = W("enterpriseName","en"),IL = W("enterpriseType","et"),UN = W("userName","userName"),UK = W("userKinds","userKinds"),ORID = W("orderId","orderId"),DBNK = W("defaultbank","defaultbank"),PLID = W("plantId","plantId"),PMY = W("payMoney","payMoney"),SRCHKW=W("searchKeyWord","searchKeyWord"),SRCHKPRC1=W("searchKeyPrc1","searchKeyPrc1"),SRCHKPRC2=W("searchKeyPrc2","searchKeyPrc2"),PRVNC=W("province","province"),CITY=W("city","city"),PFC=W("proFirstCat","proFirstCat"),PSC=W("proSecCat","proSecCat"),BTY=W("businessType","businessType"),PRID=W("prid","prid"),SHOPID=W("shopId","shopId"),TABTXT=W("tabTxt","tabTxt"),PROTYPE=W("proType","proType");
    var ST = W("shopType","sht"),SA = W("shopAddress","sha"),CNTCT=W("contact","contact"),PHONE=W("phone","phone"),USERID=W("userId","userId"),QQ=W("qq","qq"),TTL=W("ttl","ttl"),PAYNUM=W("payNumber","payNumber")/*,ECA=W("isEcAction","isEca"),ECAT=W("ecActionType","ecAt")*/;
    W("productIndex", "prn");

    var Oe = W("useBeacon", void 0, !1), ha = W("transport"), Hb = W("sessionControl", "sc", ""); W("sessionGroup", "sg");
    var zb = W("queueTime", "qt"), md = W("_s", "_s"), Oa = W("screenName", "cd"), Pa = W("location", "url", ""), Qa = W("referrer", "referrer"), Ra = W("page", "dp", ""), Sa = W("hostname", "dh"), Ta = W("language", "ul"), Ua = W("encoding", "de"), Va = W("title", "dt",
        function() {
    ...
    var p = /^(GTM|OPT)-[A-Z0-9]+$/,
        ...
        w = function(a) {
            ...
            var c ="";//= "https://gol.csc86.com/gtm/js?id=" + P(a.id);
    ...
    var Nd, Od = function(a, b, c) {
        if (!Nd) {
            ...
            window._utcp || (window._utcp = c),
                a = e[1],
                //Ea("https://gol.csc86.com/analytics/web/inpage/pub/inpage.js?" + (a ? "prefix=" + a + "&": "") + ae(), "_gasojs");
                Nd = !0
        }
    };
    ...
    var x = function(a, b, c) {
        ...
        z = function(a, b, c, d, e) {
            if (!t(Re.get(b)) && !Te.get(b)) {
                ...
                c ? (
                    c && 0 <= c.indexOf("/") ||
                    (c = ($b || df() ? "https:": "http:") + "//res.csc86.com/v2/l/ga/plugins/ua/" + c),
        ...
        C = function(a) {
            ...
            //if (H(a.url, "https://gol.csc86.com/gtm/js?id=")) return ! 0;
            if (a.query || 0 <= a.url.indexOf("?") || 0 <= a.path.indexOf("://")) return ! 1;
            if (a.host == b.host && a.port == b.port) return ! 0;
            b = "http:" == a.protocol ? 80 : 443;
            return "res.csc86.com" == a.host && (a.port || b) == b && H(a.path, "/ga/plugins/") ? !0 : !1
        },
        Ue = function(a) {
            function b(a) {
...
//                        var d = b[c].src;
//                        if (d && 0 == d.indexOf("https://gol.csc86.com/analytics")) {
//                            F(33);
//                            b = !0;
//                            break a
//                        }
//                    }
    ...
    Z.dump = Z.ga;
    J("调试模式启动，上线请关闭调试模式。（华南城网:www.csc86.com）");
    var ca = Z.P,
