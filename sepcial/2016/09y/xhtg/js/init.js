	 ...
	 /*//顶部导航
		...
		$(function(){
		  ...
		  nava.hover(function(){
			...
			$(this).find('.navtxt').css('color','#ffff72');
			$(this).addClass('cur');
			$(this).find('img').attr('src','image/hxtop'+index+'-1.png')
			/*for(var i=0;i<len;i++)
			{
				if(i==index)
				{
					$("#navbox").find('li').eq(i).addclass('cur');
		  	...
		  	$(this).find('.navtxt').css('color','#fff');
			$(this).find('img').attr('src','image/hxtop'+index+'.png')
		  });
