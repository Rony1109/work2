...
//表单提交
	...
	$.get("http://api.csc86.com/api/member/islogin",function(data){
		if(data.status==true){
			artDialog({padding:"0 20px 20px",content:'<div class="tabletop"></div><div class="tablewidth"><div class="tab-title"><span class="til-lay">申请诊断大师服务</span><span class="tmin-lay"></span><a class="g-f-r" href="javascript:;" title="" onclick="closet()"></a></div><table  border="0" cellspacing="0" cellpadding="0">'+
		  ...
		  '<tr><td><span>电子邮箱:</span><input name="yx" type="text" /></td><td>&nbsp;</td></tr></table><div class="tip-lay">注：请填写真实的联系资料，带*标为必填项目。</div></div>',
		ok: function() {
			var qymc=$("input[name='qymc']").val(),
				...
				$.post("http://cncms.csc86.com/formguide/index.php",{"formid": 71,"subtype": "ajax","dosubmit":"诊断大师","info[qymc]":qymc,"info[lxr]":lxr,"info[sshy]":sshy,"info[lxdh]":lxdh,"info[wpwz]":wpwz,"info[qq]":qq,"info[yx]":email},function(data){	
				if(data.status == true){
...
/*function layer(){
	$.get("http://api.csc86.com/api/member/islogin",function(data){
		if(data.status==true){
			artDialog({padding:"0 20px 20px",content:'<div class="tablewidth"><div class="tab-title"><span class="til-lay">申请诊断大师服务</span><span class="tmin-lay">领取五项特权</span><a class="g-f-r" href="javascript:;" title="" onclick="closet()"></a></div><table  border="0" cellspacing="0" cellpadding="0">'+
		  '<tr><td><span><em>*</em>企业名称:</span><input name="qymc" type="text" /></td><td><span><em>*</em>联系人:</span><input name="lxr" type="text" /></td></tr>'+
		  '<tr><td><span><em>*</em>所属行业:</span><input name="sshy" type="text" /></td><td><span><em>*</em>联系电话:</span><input name="lxdh" type="text" /></td></tr>'+
		  '<tr><td><span><em>*</em>旺铺网址:</span><input name="wpwz" type="text" /></td><td><span><em>*</em>QQ:</span><input name="qq" type="text" /></td></tr>'+
