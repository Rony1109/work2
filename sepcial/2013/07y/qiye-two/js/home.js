$(function(){
	...
	$(".banner .imgb").hover(function (){
		var $th=$(this);
		$th.find(".img01").css("display","none").siblings(".img02").css("display","block");
		$th.removeClass("bna").addClass("bhover");
	 },function (){
		var $th=$(this);
		$th.find(".img02").css("display","none").siblings(".img01").css("display","block");
		$th.removeClass("bhover").addClass("bna");
	 });
