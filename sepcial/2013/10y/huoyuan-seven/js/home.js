$(function(){
	...
	$(".down-cont span").click(function(){
		$th=$(this);
		if($th.parent().children().hasClass("cur")&&!$(this).hasClass("cur")){
			$th.parent().children().removeClass("cur");
			$(".info-pr li").css("display","none");
			$(this).addClass("cur");	
			$th.closest(".content").next(".info-pr").children("li:eq("+$(this).index()+")").css("display","block");
		}else if($th.parent().children().hasClass("cur")&&$(this).hasClass("cur")){
			$(".info-pr li").slideUp();
			$th.parent().children().removeClass("cur");
		}else{
			$th.parent().children().removeClass("cur");
			$th.closest(".content").next(".info-pr").children("li").css("display","none");
			$(this).addClass("cur");	
			$th.closest(".content").next(".info-pr").children("li:eq("+$(this).index()+")").slideDown();
		}
	});
