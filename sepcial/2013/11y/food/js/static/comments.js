define(function(require, exports, module){
	...
	module.exports = {
		get: function(elem){
			$.get('http://quan.csc86.com/interface/replyList', {topicId:'c9e807fd-3b6f-4bce-8c74-0fbd4b8da05e'}, function(data){
				var i, j, html = '';
		...
		send: function(elem, sub){
			var curObj = this;
			$(sub).on('click', function(){
					$.get('http://quan.csc86.com/interface/submitReply', {topicId:'c9e807fd-3b6f-4bce-8c74-0fbd4b8da05e', replyContent: $(elem).val().replace(/\[em\_(\d+)\]/gi,'<img border="0" src="http://res.csc86.com/js/p/kindeditor/4.1.2/plugins/emoticons/images/$1.gif">')}, function(data){
						switch(data.code) {
							case 'login_fail':
								alert("请登陆或注册会员后发表评论");
