...
define(function(require, exports, module) {
	...
	(function(){
	    ...
	    $(".wrj-gn-img1").mousemove(function(){
			$(this).find('img').show();
		});
		$(".wrj-gn-img1").mouseout(function(){
			$(this).find('img').hide();
		});
		
		$(".wrj-gn-img2").mousemove(function(){
			$(this).find('img').show();
		});
		$(".wrj-gn-img2").mouseout(function(){
			$(this).find('img').hide();
		});
		$(".wrj-gn-img3").mousemove(function(){
			$(this).find('img').show();
		});
		$(".wrj-gn-img3").mouseout(function(){
			$(this).find('img').hide();
		});
		$(".wrj-gn-img4").mousemove(function(){
			$(this).find('img').show();
		});
		$(".wrj-gn-img4").mouseout(function(){
			$(this).find('img').hide();
		});
