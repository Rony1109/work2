...
function up(url,pos,name){
	$.get(url,{pos:pos},function(e){
		if(e.status){
			window.top.art.dialog({id:"up",time:1,title:"『"+name+"』",content:"...碎片更新成功！"})
		}else{
			window.top.art.dialog({id:"up",time:1,title:"『"+name+"』",content:"...碎片更新失败！"})
		}
	},"jsonp");
};