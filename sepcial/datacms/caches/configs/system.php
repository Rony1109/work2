...
'cookie_pre' => 'vBamt_', //Cookie 前缀，同一域名下安装多套系统时，请修改Cookie前缀
...
'upload_url' => 'http://data.csc86.com/uploadfile/', //附件路径
...
'app_path' => 'http://data.csc86.com/',//动态域名配置地址
...
'gzip' => 1, //是否Gzip压缩后输出
'auth_key' => 'N99XISKKL8X29EgYqfDG', //密钥
'lang' => 'zh-cn',  //网站语言包
...
'phpsso' => '1',	//是否使用phpsso
'phpsso_appid' => '1',	//应用id	
'phpsso_api_url' => 'http://data.csc86.com/phpsso_server',	//接口地址
'phpsso_auth_key' => 'uBEK7kqrzTu7rZAlugl6mG9m78Ue9B8M', //加密密钥
...
'plugin_debug' => '0',	//插件测试
'admin_url' => 'dtmanage.csc86.com',	//允许访问后台的域名
);
?>