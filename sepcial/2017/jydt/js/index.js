...
var html='';
	$.each(data.data.row,function(){
		...
		html+='<li><div class="em1">'+arr+'</div><a href="#" target="_blank"><div class="em2">'+me.productName+'</div></a><a href="javascript:;" title="3400"><div class="em2">'+me.number.replace(/\.00$/,"")+'</div></a><div class="em3">'+me.payTime.replace(/\:\d{2}$/,"")+'</div></li>';
		});
