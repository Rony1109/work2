define(function(require, exports, module) {
    ...
    var url = _c.debug ? "/market/json/company.json" : "//" + hostmap.test + "/search/company.do";
                    ...
                    for (var j = 0, len = companyList.length; j < len; j++) {
                        ...
                        result +=
                            "<li class= 'sh_pd_30 sh_bg_color_1'>" +
                                "<a class='sh_font_color5' href="+ '//'+hostmap.test + '/shop/index_shop.ftl?memberid=' + companyList[j].memberId+ ">" +
