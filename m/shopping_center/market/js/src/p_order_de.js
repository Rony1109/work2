                ...
                success: function (data) {
                    ...
                    if(data.status==100){
                        ...
                        for(var i=0;i<len;i++){
                            ...
                            "<a href='http://m.csc86.com/search/product_detail.ftl?productId="+data.data.orderDetail.details[i].productId+"' target='_blank' >"+
                            ...
                            "<div>"+"<a href='http://m.csc86.com/search/product_detail.ftl?productId="+data.data.orderDetail.details[i].productId+"' target='_blank' class='sh_font_color5'>"+ data.data.orderDetail.details[i].productName+"</a>"+"</div>"+
