                       ...
                       if(num==1){
                        ...
                        for (var i = 0; i < len; i++) {
                            ...
                            "<div class='sh_clear sh_pd_top13 sh_pd_bottom13 sh_bor_bottom_1 save_store_imgh '>" +
                             "<a href='//res.csc86.com/v3/dmg/market/html/p_order_de.html?id="+data.data.myOrderList.resultList[i].orderNo+"'class='sh_font_sz0'>"+
                        ...
                        $('.goordermoney').on('click',function(){
                            ...
                            if(weixins.isWeiXin()){
                               // 新增跳转到二维码付款页面
                                ...
                                window.location.href = "//res.csc86.com/v3/dmg/market/html/qrcode_payment.html?orderId=" + $goordermoney;
                            }else{
