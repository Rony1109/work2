define(function(require, exports, module) {
    ...
    //     {id: "size", value: "尺码"}
    // ];
    var ShangPinModel = function (id, sellerId, quoteType, specNames, maxNum,sellerName,imageUrl,productName,candId) {//初始化产品id，报价方式，参数名称，最大数量
    ...
    ShangPinModel.prototype = {
        ...
        getPriceDefer: function (specsObj) {//价格
            ...
            return $.ajax($.extend({
                data:{"color": specsObj || this.specs.color,"size":specsObj || this.specs.size,"minProductCount": $(".pro_de_num").eq(0).text()}
        ...
        setSpecProperty: function (specName, val) {
            if (this.specNames.indexOf(specName) < 0) throw new Error("invalid spec name:" + specName);
            this.specsProperty[specName] = val || 0;
            return this;
        },
