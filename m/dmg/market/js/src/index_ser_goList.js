define(function(require, exports, module) {
    ...
    var url = _c.debug ? "/market/json/good_list.json" : "//" + hostmap.test + "/search/product.do?shopType=dm";
                            ...
                            "<div class='sh_clear  sh_pd_top30  sh_pd_bottom30 sh_bor_top_1 sh_bg_color_1'>"+
                                "<div class='sh_width_92 sh_margin_a  sh_clear '>"+
                                    "<div class='sh_width_4 sh_float_l sh_lingheight_100  sh_font_sz0 '>"+
                                         "<a href='//"+hostmap.test+"/dmg/product/"+productList[j].productId+"'  data-href='"+productList[j].productId+"'>"+"<img src='"+productList[j].picUrl+"' class='index_ser_list' alt=''/>"+"</a>"+
                                    "</div>"+
                                    "<div class='sh_width_8 sh_float_l sh_wor_space  sh_positon_r sh_font_sz0'>"+
                                         "<a href='//"+hostmap.test+"/dmg/product/"+productList[j].productId+"'  data-href='"+productList[j].productId+"'>"+"<span class='sh_di_block sh_font_sz32 li-ht42 sh_pd_bottom10 sh_font_color5 sh_font_700'>"+productList[j].title+"</span>"+"</a>"+
