...
var isFlag=false;
function isLogin(obj,url1,url2,fn){
    ...
    $.ajax({
        ...
        url: url1,
        dataType:"jsonp",
        data: "q="+Math.random(), //例如："name=John&location=Boston";
        success: function(data){
            if(data.status){
                $.get(url2,{type:"json"},function(dataMsg){ 

                    var html = '您好  <a href="//member.csc86.com/" target="_blank">';
                        html +=data.data.userName + '</a>！消息<a href="//member.csc86.com/membercenter/messagelist/" target="_blank" class="top-msg-num">';
                        html += dataMsg.data.count + '</a><span class="v-line"></span><a href="//member.csc86.com/login/logout">退出</a><span class="v-line"></span>';
