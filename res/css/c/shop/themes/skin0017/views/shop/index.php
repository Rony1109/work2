...
<div class="g-o-a">
	<div class="main home">
		<div class="box-home rec-product">
			...
			<div class="bh-bd">
				...
				<ul class="g-c-f g-i-v-m rec-list">
					...
					<li class="item">
						<div class="inner">
							<div class="ibox"> <a href="/product/<?php echo CSCHelper::setDefault($value['id'])?>.html" class="i" target="_blank"><span class="img-shade"></span> <img src="<?php echo ShopHelper::scale($value['pic1'],300);?>" data-max="246" alt="<?php echo CSCHelper::setDefault($value['title']);?>" /> </a> </div>
		...
		<div class="box-home hot-product">
			<div class="bh-hd">
				<h2><a href="/product.html" class="more" rel="nofollow">更多</a><span>热门产品</span></h2>
			</div>
			<div class="bh-bd">
