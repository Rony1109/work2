	...
	<div class="g-o-a">
		...
		<ul class="g-f-r follow-fav">
			<li class="ff-follow"><div class="cir"><em>
					...
					</em>个圈友</div><i class="iocl"></i><span class="g-d-ib"> <a href="<?php echo QUAN_URL.'/index.html?circleId='.CSCHelper::setDefault( $enterprise['enpCircleId'] )?>"  target="_blank" class="g-ico <?php if (CSCHelper::setDefault( $myself['joinEnpCircleFlag'] )){echo 'ico-followed';}else{echo 'ico-follow';}?>" rel="nofollow">
			...
			<li class="ff-fav"><div class="cir"><em>
					...
					</em>人喜欢</div><i class="iocl"></i><span class="g-d-ib"><a href="javascript:void(csc.shop.signLike('<?php echo $enterprise['id'];?>'));" class="g-ico ico-fav<?php if (CSCHelper::setDefault( $myself['likedFlag'] )) echo ' ico-faved';?>" rel="nofollow">
