<div class="box-sub company-info">
	...
	<div class="inner">
		...
		<?php }else{?>
		<div class="g-t-c shop-fav"><a class="g-d-ib" href="javascript:void(csc.shop.fav('<?php echo $enterprise['id'];?>',null,'shop'));" rel="nofollow"><span class="g-v-h">收藏旺铺</span></a></div>
	 	<?php }?>
