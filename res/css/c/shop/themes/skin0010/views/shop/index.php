...
<div class="g-o-a">
	<div class="main home">
		<div class="box-home rec-product">
			...
			<div class="bh-bd">
				...
				<ul class="g-c-f g-i-v-m rec-list">
					...
					<li class="item">
						 <span class="round_t"></span>
						<div class="inner">
							<div class="ibox"> <a href="/product/<?php echo CSCHelper::setDefault($value['id'])?>.html" class="i" target="_blank"> <img src="<?php echo ShopHelper::scale($value['pic1'],300);?>" data-max="238" alt="<?php echo CSCHelper::setDefault($value['title']);?>" /> </a> </div>
		...
		<div class="box-home hot-product">
			<div class="bh-hd">
				<h2><a href="/product.html" class="more" rel="nofollow">查看更多</a>热门产品</h2>
			</div>
			<div class="bh-bd">
				...
				<ul class="g-c-f g-i-v-m thumb-list">
					...
					<li class="item">
						 <span class="round_t1"></span>
						<div class="inner">
							<div class="ibox"> <a href="/product/<?php echo CSCHelper::setDefault($value['id'])?>.html" class="i" target="_blank"> <img src="<?php echo ShopHelper::scale($value['pic1'],300);?>" data-max="160" width="160" height="160" alt="<?php echo CSCHelper::setDefault($value['title']);?>" /> </a> </div>
							<div class="bg"> <a href="/product/<?php echo CSCHelper::setDefault($value['id'])?>.html" class="t" target="_blank">
								<?php echo CSCHelper::setDefault($value['title'])?>
								</a>
								<div class="item_btn">
								...
								<a href="http://jiaoyi.csc86.com/inquiry/publish/?proid=<?php echo CSCHelper::setDefault($value['id'])?>" class="g-ico ico-inquiry" target="_blank" rel="nofollow">询盘</a></div></div>
						</div>
						 <span class="round_b1"></span>
					</li>
					<?php }?>
				</ul>
				<?php }else{ ?>
