...
<div class="g-o-a">
	<div class="main product">
		<div class="bo_inner">
			<div class="main-cate">
				<?php if($this->cate != ''){?>
				<h2><?php echo CSCHelper::setDefault($this->cateshow['title']);?><span>(
			...
			<div class="hot-product product-list">
				...
				<ul class="g-c-f g-i-v-m thumb-list">
					...
					<li class="item">
						...
						<div class="inner">
							<div class="ibox"><a href="/product/<?php echo CSCHelper::setDefault($value['id'])?>.html" class="i" target="_blank"><img src="<?php echo ShopHelper::scale($value['pic1'],300)?>" data-max="160" height="160" width="160" alt="<?php echo CSCHelper::setDefault($value['title']);?>" /></a></div>
