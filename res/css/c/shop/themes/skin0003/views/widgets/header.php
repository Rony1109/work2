<div class="g-o-a head">
	...
	<ul class="g-f-r follow-fav">
		<li class="ff-follow"><em><?php echo $enterprise['enpCircleMemberNum'];?></em>个圈友<span>
		<a href="<?php echo QUAN_URL.'/index.html?circleId='.CSCHelper::setDefault( $enterprise['enpCircleId'] )?>"  target="_blank" class="g-ico <?php if (CSCHelper::setDefault( $myself['joinEnpCircleFlag'] )){echo 'ico-followed';}else{echo 'ico-follow';}?>" rel="nofollow"><?php if (CSCHelper::setDefault( $myself['joinEnpCircleFlag'] )){echo '已加入';}else{ echo '加入圈';}?></a></span></li>		
		<li class="ff-fav"><em><?php echo $enterprise['likeNum'];?></em>人喜欢<span><a href="javascript:void(csc.shop.signLike('<?php echo $enterprise['id'];?>'));" class="g-ico ico-fav<?php if (CSCHelper::setDefault( $myself['likedFlag'] )) echo ' ico-faved';?>" rel="nofollow"><?php if (CSCHelper::setDefault( $myself['likedFlag'] )){echo '已喜欢';}else{echo '我喜欢';}?></a></span></li>
	</ul>
</div>
<ul class="g-o-a nav">
