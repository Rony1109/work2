	...
	<div class="main product-detail">
		<div class="bo_inner">
			<ol class="crumb">
				...
				<li><a href="/scate/<?php echo CSCHelper::setDefault($value['id'])?>.html" target="_blank">
					<?php echo CSCHelper::setDefault($value['name'])?>
					</a>&gt;</li>
				<?php }}?>
				<li><strong>
					<?php echo CSCHelper::setDefault($pdetail['title'])?>
					</strong></li>
			</ol>
			<div class="detail-info">
				...
				<div class="g-c-f">
					<div class="g-f-r di-params">
						<table class="di-price">
							<thead>
								<tr>
									<th>订货量（
										<?php echo CSCHelper::setDefault($pdetail['unitsVale'])?>
										）：</th>
									<td>价格：</td>
								</tr>
							</thead>
							<tbody>
								...
								<tr>
									<th>≥
										<?php echo CSCHelper::setDefault($value['more']);?></th>
									<td><strong>
										<?php echo CSCHelper::setDefault($value['detail']);?>
										</strong> 元/
										<?php echo CSCHelper::setDefault($pdetail['unitsVale'])?></td>
								</tr>
								<?php }}?>
								<?php }else{?>
								<tr>
						...
						<div class="di-attr">
							...
							<table width="100%">
								<tr>
									<td>类别：
										<?php echo CSCHelper::setDefault($pdetail['scateName'])?></td>
								</tr>
							</table>
						</div>
						<div class="inquiry-fav"> <a href="http://jiaoyi.csc86.com/inquiry/publish/?proid=<?php echo CSCHelper::setDefault($pdetail['id'])?>" class="g-f-l" target="_blank" rel="nofollow">立即询盘</a> <a href="javascript:void(csc.shop.order('<?php echo CSCHelper::setDefault($pdetail['id'])?>'));" class="g-f-l di-order" rel="nofollow" data-memberid="<?php echo CSCHelper::setDefault($pdetail['memberid'])?>">意向订单</a>
					...
					<div class="g-i-v-m di-thumb">
						<div class="thumb-img ibox"> <a class="i" href="<?php echo IMG_URL.newthumbex(CSCHelper::setDefault($pdetail['pic1']),4)?>" target="_blank"> <img src="<?php echo IMG_URL.newthumbex(CSCHelper::setDefault($pdetail['pic1']),3)?>" alt="<?php echo CSCHelper::setDefault($pdetail['title'])?>" data-max="300"/> </a> </div>
						<ul class="g-c-f thumb-items">
							...
							<li class="ibox"><span class="arr"></span> <a class="i" href="<?php echo ShopHelper::image($value['imgUrl'])?>" target="_blank"> <img src="<?php echo ShopHelper::image($value['imgUrl'])?>" alt="<?php echo CSCHelper::setDefault($pdetail['title'])?>" data-max="60" /> </a> </li>
							<?php }}?>
						</ul>
					</div>
				</div>
				...
				<ul class="di-tab-bd">
					...
					<li class="di-tab-bd-item detail-params">
						<ul class="g-c-f" >
							...
							<li> <span>
								<?php echo CSCHelper::setDefault($value['propertyName'])?>
								:</span>
								<div>
									<?php echo CSCHelper::setDefault($value['propertyvalue'])?>
								</div>
							</li>
							<?php }}?>
						</ul>
