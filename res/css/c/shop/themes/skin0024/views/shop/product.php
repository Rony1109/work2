  ...
  <div class="main product">
    <div class="bo_inner">
      ...
      <div class="hot-product product-list">
        ...
        <ul id="thumb-list" class="g-c-f g-i-v-m thumb-list">
          <?php foreach (ShopHelper::XmlCallBack('getProductList') as $value){?>
          <li class="item">
            <div class="inner">
              <div class="ibox"><a href="/product/<?php echo CSCHelper::setDefault($value['id'])?>.html" class="i" target="_blank"><span class="t_l"></span> <span class="t_r"></span> <span class="b_l"></span> <span class="b_r"></span><img src="<?php echo ShopHelper::scale($value['pic1'],300)?>" data-max="160" alt="<?php echo CSCHelper::setDefault($value['title']);?>" /></a></div>
      ...
      <script>
		   $("#thumb-list li:nth-child(4n)").addClass("marg_r1");
	</script> 
    </div>
  </div>
<script>
...
<div class="sub"><?php CSCHelper::widgets(array('Company','Cate','HotProduct'
));?></div>
