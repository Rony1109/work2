<div class="head">
	<div class="g-o-a">
		...
		<ul class="g-f-r follow-fav">
			<li class="ff-follow"> <a href="<?php echo QUAN_URL.'/index.html?circleId='.CSCHelper::setDefault( $enterprise['enpCircleId'] )?>"  target="_blank" class="g-ico <?php if (CSCHelper::setDefault( $myself['joinEnpCircleFlag'] )){echo 'ico-followed';}else{echo 'ico-follow';}?>" rel="nofollow"><i class="iocl"></i>
				<?php if (CSCHelper::setDefault( $myself['joinEnpCircleFlag'] )){echo '已加入';}else{ echo '加入圈';}?>
				<span class="cir"><em>
				<?php echo $enterprise['enpCircleMemberNum'];?>
				</em>个圈友</span></a></li>
			<li class="ff-fav"><a href="javascript:void(csc.shop.signLike('<?php echo $enterprise['id'];?>'));" class="g-ico ico-fav<?php if (CSCHelper::setDefault( $myself['likedFlag'] )) echo ' ico-faved';?>" rel="nofollow"><i class="iocl"></i>
