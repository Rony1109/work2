<div class="head">
	<div class="g-o-a">
		...
		<ul class="g-f-r follow-fav">
			<li class="ff-follow"><div class="cir"><em>
					<?php eo($this->shopinfo, 'enpCircleMemberNum')?>
					</em>个圈友</div><i class="iocl"></i><span class="g-d-ib"> <a href="<?php echo QUAN_URL.'/index.html?circleId='.setDefault($this->shopinfo, 'enpCircleId')?>"  target="_blank" class="g-ico <?php if (setDefault($this->myself, 'joinEnpCircleFlag')){echo 'ico-followed';}else{echo 'ico-follow';}?>" rel="nofollow">
				<?php if (setDefault($this->myself,'joinEnpCircleFlag')){echo '已加入';}else{ echo '加入圈';}?>
				</a></span>
				
			</li>
			<li class="ff-fav"><div class="cir"><em>
					<?php eo($this->shopinfo, 'likeNum')?>
					</em>人喜欢</div><i class="iocl"></i><span class="g-d-ib"><a href="javascript:void(csc.shop.signLike('<?php eo($this->shopinfo, 'id')?>'));" class="g-ico ico-fav<?php if (setDefault($this->myself, 'likedFlag')) echo ' ico-faved';?>" rel="nofollow">
			...
			<div class="g-c-f">
				...
				<div class="g-i-v-m di-thumb">
					...
					<?php if(setDefault($this->pdetail, 'picarr')){foreach (setDefault($this->pdetail, 'picarr') as $value){?>
						<li class="ibox"><span class="arr"></span>
