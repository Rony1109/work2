<div class="box-sub company-info">
	...
	<div class="inner">
		...
		<div class="g-t-c shop-fav shop-faved"><a href="javascript:" rel="nofollow"><span class="g-v-h">旺铺已收藏</span></a></div>
		<?php }else{?>
		<div class="g-t-c shop-fav"><a class="g-d-ib" href="javascript:void(csc.shop.fav('<?php eo($this->shopinfo, 'id')?>',null,'shop'));" rel="nofollow"><span class="g-v-h">收藏旺铺</span></a></div>
	 	<?php }?>
