      ...
      <div class="box-home rec-product">
        ...
        <div class="bh-bd">
          ...
          <ul class="g-c-f g-i-v-m rec-list">
            ...
            <li class="item">
              <div class="inner">
                 <div class="bg">  <div class="ibox"> <a href="/product/<?php eo($value, 'id')?>.html" class="i" target="_blank"> <img src="<?php eo($value, 'pic1')?>" data-max="238" alt="<?php eo($value, 'title');?>" /> </a> </div>
              <a href="/product/<?php eo($value, 'id')?>.html" class="t" target="_blank">
                  <?php eo($value, 'title');?>
                  </a></div><div class="cot">
      ...
      <div class="box-home hot-product">
        ...
        <div class="bh-bd">
          ...
          <ul class="g-c-f g-i-v-m thumb-list">
            ...
            <li class="item">
              <div class="inner">
               <div class="bg">  <div class="ibox"> <a href="/product/<?php eo($value, 'id')?>.html" class="i" target="_blank"> <img src="<?php eo($value, 'pic1')?>" data-max="160" alt="<?php eo($value, 'title');?>" /> </a> </div>
                <a href="/product/<?php eo($value, 'id')?>.html" class="t" target="_blank">
                  <?php eo($value, 'title')?>
                  </a></div><div class="cot">
                  <div class="price"> <strong>
