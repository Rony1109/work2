<div class="head">
	<div class="g-o-a">
		...
		<ul class="g-f-r follow-fav">
			<li class="ff-follow"> <a href="<?php echo QUAN_URL.'/index.html?circleId='.setDefault($this->shopinfo, 'enpCircleId')?>"  target="_blank" class="g-ico <?php if (setDefault($this->myself, 'joinEnpCircleFlag')){echo 'ico-followed';}else{echo 'ico-follow';}?>" rel="nofollow"><i class="iocl"></i>
				<?php if (setDefault($this->myself,'joinEnpCircleFlag')){echo '已加入';}else{ echo '加入圈';}?>
				<span class="cir"><em>
				<?php eo($this->shopinfo, 'enpCircleMemberNum')?>
				</em>个圈友</span></a></li>
			<li class="ff-fav"><a href="javascript:void(csc.shop.signLike('<?php eo($this->shopinfo, 'id')?>'));" class="g-ico ico-fav<?php if (setDefault($this->myself, 'likedFlag')) echo ' ico-faved';?>" rel="nofollow"><i class="iocl"></i>
