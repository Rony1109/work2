<div class="head">
	<div class="g-o-a">
		...
		<ul class="g-f-r follow-fav">
			<li class="ff-follow"><span><a href="<?php echo QUAN_URL.'/index.html?circleId='.setDefault($this->shopinfo, 'enpCircleId')?>"  target="_blank" class="g-ico <?php if (setDefault($this->myself, 'joinEnpCircleFlag')){echo 'ico-followed';}else{echo 'ico-follow';}?>" rel="nofollow"><i class="iocl"></i>
			...
			<li class="ff-fav"><span><a href="javascript:void(csc.shop.signLike('<?php eo($this->shopinfo, 'id')?>'));" class="g-ico ico-fav<?php if (setDefault($this->myself, 'likedFlag')) echo ' ico-faved';?>" rel="nofollow"><i class="iocl"></i>
...
<ul class="g-o-a nav">
	<li class="item <?php if($this->lamp == 'index'){?>cur <?php }?> "> <a href="/" class="item-txt item_nat1">首　页</a> </li>
	<li class="item pro <?php if($this->lamp == 'product'||$this->lamp == 'pdetail'){?>cur <?php }?>"> <a href="/product.html" class="item-txt item_nat2">产品中心</a> <span class="item-arr"></span>
		<div class="nav-cate">
			<ul class="cate-1th">
	...
	<li class="item <?php if($this->lamp == 'authentication'){?>cur <?php }?> "> <a href="/authentication.html" class="item-txt item_nat3">诚信档案</a> </li>
	<li class="item <?php if($this->lamp == 'news'||$this->lamp == 'tdetail'){?>cur <?php }?> "> <a href="/news.html" class="item-txt item_nat4">公司动态</a> </li>
	<li class="item <?php if($this->lamp == 'about'){?>cur <?php }?>"> <a href="/about.html" class="item-txt item_nat5" >关于我们</a> </li>
</ul>
<script>
csc.ie6 && seajs.use(csc.url("res","/f=js/m/hover"),function (){
	csc.hover("ul.nav>li");
