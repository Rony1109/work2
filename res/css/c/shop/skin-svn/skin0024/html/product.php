...
<div class="g-o-a">
  <div class="main product">
    <div class="bo_inner">
      <div class="main-cate">
        <?php if($this->cate != ''){?>
        <h2 class="bh-hd"><?php echo setDefault($this->cateshow, 'title');?><span>(
      ...
      <div class="hot-product product-list">
        ...
        <ul id="thumb-list" class="g-c-f g-i-v-m thumb-list">
          ...
          <li class="item">
            <div class="inner">
              <div class="ibox"><a href="/product/<?php eo($value, 'id')?>.html" class="i" target="_blank"><span class="t_l"></span> <span class="t_r"></span> <span class="b_l"></span> <span class="b_r"></span><img src="<?php eo($value, 'pic1')?>" data-max="160" alt="<?php eo($value, 'title');?>" /></a></div>
