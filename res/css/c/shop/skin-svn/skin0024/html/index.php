	...
	<div class="main home">
		<div class="box-home rec-product">
			...
			<div class="bh-bd">
				...
				<ul id="rec-list" class="g-c-f g-i-v-m rec-list">
					<?php foreach ($this->getList('getShopProductList') as $value){?>
					<li class="item">
						<div class="inner">
							<div class="ibox"> <a href="/product/<?php eo($value, 'id')?>.html" class="i" target="_blank"><span class="img-shade"></span> <img src="<?php eo($value, 'pic1')?>" data-max="248" alt="<?php eo($value, 'title');?>" /> </a> </div>
              ...
              <script>
		   $("#rec-list li:nth-child(3n)").addClass("marg_r");
	</script>
		</div>
