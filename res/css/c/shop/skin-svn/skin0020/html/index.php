    ...
    <div class="box-home rec-product">
      ...
      <div class="bh-bd">
        ...
        <ul class="g-c-f g-i-v-m rec-list">
          ...
          <li class="item">
            <div class="inner">
              <div class="ibox"> <a href="/product/<?php eo($value, 'id')?>.html" class="i" target="_blank"><span class="img-shade"></span> <img src="<?php eo($value, 'pic1')?>" data-max="250" alt="<?php eo($value, 'title');?>" /> </a> </div>
