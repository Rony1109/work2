...
<div class="g-o-a">
	<div class="main home">
		<div class="box-home rec-product">
			<div class="bh-hd">
				<h2>橱窗产品<b class="tin0">PRODUCT<i></i>SHOWCASE</b></h2>
			</div>
			<div class="bh-bd">
				...
				<ul class="g-c-f g-i-v-m rec-list">
					...
					<li class="item">
						<div class="inner">
							<div class="ibox"> <a href="/product/<?php eo($value, 'id')?>.html" class="i" target="_blank"><span class="t_l"></span>
                  <span class="t_r"></span>
                  <span class="b_l"></span>
                  <span class="b_r"></span> <img src="<?php eo($value, 'pic1')?>" data-max="250" alt="<?php eo($value, 'title');?>" /> </a> </div>
		...
		<div class="box-home hot-product">
			<div class="bh-hd">
				<h2><a href="/product.html" class="more" rel="nofollow">[查看更多]</a>热门产品<b>HOT<i></i>SHOWCASE</b></h2>
			</div>
			<div class="bh-bd">
				...
				<ul class="g-c-f g-i-v-m thumb-list">
                  ...
                  <span class="t_r"></span>
                  <span class="b_l"></span>
                  <span class="b_r"></span> <img src="<?php eo($value, 'pic1')?>" data-max="160" alt="<?php eo($value, 'title');?>" /> </a> </div>
							<div class="bg"> <a href="/product/<?php eo($value, 'id')?>.html" class="t" target="_blank">
								<?php eo($value, 'title')?>
								</a>
								<div class="price"> <strong>
