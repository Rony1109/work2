			...
			<div class="bh-bd">
				...
				<ul class="g-c-f g-i-v-m thumb-list">
					...
					<li class="item">
						...
						<div class="inner">
							<div class="ibox"> <a href="/product/<?php eo($value, 'id')?>.html" class="i" target="_blank"> <img src="<?php eo($value, 'pic1')?>" data-max="160" width="160" height="160" alt="<?php eo($value, 'title');?>" /> </a> </div>
							<div class="bg"> <a href="/product/<?php eo($value, 'id')?>.html" class="t" target="_blank">
								<?php eo($value, 'title')?>
								</a>
								<div class="item_btn">
								...
								<a href="http://jiaoyi.csc86.com/inquiry/publish/?proid=<?php eo($value, 'id')?>" class="g-ico ico-inquiry" target="_blank" rel="nofollow">询盘</a></div></div>
						</div>
