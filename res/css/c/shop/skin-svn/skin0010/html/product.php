			...
			<div class="hot-product product-list">
				...
				<ul class="g-c-f g-i-v-m thumb-list">
					...
					<li class="item">
						...
						<div class="inner">
							<div class="ibox"><a href="/product/<?php eo($value, 'id')?>.html" class="i" target="_blank"><img src="<?php eo($value, 'pic1')?>" data-max="160" height="160" width="160" alt="<?php eo($value, 'title');?>" /></a></div>
