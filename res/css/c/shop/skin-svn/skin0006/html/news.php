	...
	<div class="main news">
		...
		<?php foreach ($this->getList('getArticleList')->list as $value){?>	
			<li <?php if($tag%5==0){?>class="line"<?php }?>>
				<h2>
					<a href="/news/<?php eo($value, 'id')?>.html" class="title" target="_blank"><?php eo($value, 'title')?></a>
				</h2>
				<span class="date"><?php eo($value, 'releaseTime')?></span>
				<span class="amount">阅读（<em><?php eo($value, 'readTimes')?></em>）</span>
			</li>
		<?php $tag++;}?>
		</ul>
