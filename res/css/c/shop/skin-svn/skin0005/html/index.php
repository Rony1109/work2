...
<div class="g-o-a">
	<div class="main home">
		<div class="box-home rec-product">
			...
			<div class="bh-bd">
				<?php if($this->getList('getShopProductList')){?><ul class="g-c-f g-i-v-m rec-list">
				<?php foreach ($this->getList('getShopProductList') as $value){?>
					<li class="item">
						<div class="ibox">
							<a href="/product/<?php eo($value, 'id')?>.html" class="i" target="_blank">
								<img src="<?php eo($value, 'pic1')?>" data-max="238" alt="<?php eo($value, 'title');?>" />
							</a>
						</div>
						...
						<?php }?>
							<a href="http://jiaoyi.csc86.com/inquiry/publish/?proid=<?php eo($value, 'id')?>" class="g-f-r g-ico ico-inquiry" target="_blank" rel="nofollow">立即询盘</a>
						</div>
					</li>
				<?php }?>
				</ul>
		...
		<div class="box-home hot-product">
			...
			<div class="bh-bd">
				<?php if($this->getList('getHotProductList')){?><ul class="g-c-f g-i-v-m thumb-list">
				<?php foreach ($this->getList('getHotProductList') as $value){?>
					<li class="item">
						<div class="ibox">
							<a href="/product/<?php eo($value, 'id')?>.html" class="i" target="_blank">
								<img src="<?php eo($value, 'pic1')?>" data-max="160" alt="<?php eo($value, 'title');?>" />
							</a>
						</div>
						<a href="/product/<?php eo($value, 'id')?>.html" class="t" target="_blank"><?php eo($value, 'title')?></a>
						<div class="price">
						...
						<a href="http://jiaoyi.csc86.com/inquiry/publish/?proid=<?php eo($value, 'id')?>" class="g-ico ico-inquiry" target="_blank" rel="nofollow">立即询盘</a>
					</li>
				<?php }?>
				</ul><?php }else{ ?>
